  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.paragraph}>
        Teachers are paid on a bi-weekly schedule. Every other Friday, all
        completed sessions and approved earnings from the previous two weeks are
        processed.
      </Text>

      <Text style={styles.sectionTitle}>📦 Payment Method</Text>
      <Text style={styles.paragraph}>
        Payments are sent via direct deposit to the bank account you provide
        during onboarding. You must complete your payout setup to begin
        receiving earnings.
      </Text>
      ...
      <Text style={styles.listItem}>
        - Complete at least one teaching session
      </Text>
      <Text style={styles.listItem}>- Ensure your bank info is up-to-date</Text>

      <Text style={styles.sectionTitle}>📊 Payout Breakdown</Text>
      <Text style={styles.paragraph}>
        Each payout includes a summary of your sessions, hours worked, and total
        earnings. You can view this breakdown in your dashboard.
      </Text>
